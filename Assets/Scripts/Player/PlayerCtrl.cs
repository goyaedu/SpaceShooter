...
public class PlayerCtrl : MonoBehaviour
{
    ...
    // 이동 속도 변수(public으로 선언되어 Inspect에 노출됨)
    [SerializeField] float moveSpeed = 10.0f;
    // 회전 속도 변수
    [SerializeField] float rotSpeed = 80.0f;
    ...
    void Start()
    {
        // 스크립트가 실행된 후 처음 수행되는 Start 함수에서 Transform
        // 컴포넌트 할당
    ...
    void Update()
    {
        ...
        {
            anim.CrossFade(playerAnim.runR.name, 0.3f);     // 왼쪽 이동 애니메이션
        }
        else
        {
